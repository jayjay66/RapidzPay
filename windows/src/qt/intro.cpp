// Copyright (c) 2011-2014 The rapidz Core developers
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/rapidz"));
        ...
        for ( ; ; )
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("RapidZ-qt"),
     ...
     * override -datadir in the rapidz.conf file in the default data directory
     * (to be consistent with rapidzd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
