...
unlocked to sign the rapidz-Qt.app bundle.
...
allowing somebody to distribute a rapidz-Qt.app or rapidz-qt-setup.exe with a valid
...
that the rapidz-qt.exe file inside the installer had not been tampered with.
